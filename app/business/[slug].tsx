...
// Same static content is shown no matter which service/pro slug is tapped.
// Swap this out later for a real lookup, e.g. businessApi.get(slug).
const PROFESSIONAL = {
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: Colors.background }]} edges={['top']}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity activeOpacity={0.9} onPress={() => router.push('/bookings/schedule')}>
          ...
          >
            <Text style={styles.bookBtnText} onPress={() => router.push('/bookings/schedule')}>
