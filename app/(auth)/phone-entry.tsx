...
//     // Read the flow state passed from the welcome screen
//     const { authMode } = useLocalSearchParams<{ authMode: 'sign_up' | 'login' }>();
...
//                 params: { 
//                     phone: phoneNumber,
//                     authMode: authMode // Pass it forward to the OTP screen
//                 }
//             });
//         }
//     };
...
//                         {/* Dynamically adjust title text based on click path */}
//                         <Text style={styles.lightTitle}>
//                             {authMode === 'login' ? 'Welcome Back!' : 'Create Account'}
//                         </Text>
//                         <Text style={styles.lightSubtitle}>
//                             {authMode === 'login' ? 'Enter your mobile number to log in' : 'We\'ll send a verification code via SMS'}
//                         </Text>
//                     </View>
...
//                     <TouchableOpacity activeOpacity={0.9} style={styles.otpButtonSpacing} onPress={handleSendOtp}>
//                         <LinearGradient
...
// // Keep your original styles unmodified below...
...
//     phoneInputRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
...
//     otpButtonSpacing: { marginBottom: 24 },
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.lightContainer}>
            ...
            <SafeAreaView style={styles.flex} edges={['top', 'bottom']}>
                <ScrollView contentContainerStyle={styles.scrollGrow} keyboardShouldPersistTaps="handled">
                    ...
                    {/* Switch back to Login Screen smoothly without visual flashes */}
                    <View style={styles.footerRedirectContainer}>
                        <Text style={styles.footerRedirectText}>Already have an account? </Text>
                        <TouchableOpacity onPress={() => router.replace({ pathname: '/(auth)/login', params: { authMode: 'login' } })}>
...
const styles = StyleSheet.create({
    ...
    actionButtonSpacing: { marginBottom: 12 },
    primaryGradientButton: { borderRadius: 16, paddingVertical: 18, alignItems: 'center', justifyContent: 'center' },
    ...
    footerRedirectText: { fontSize: 14, color: '#8E8E93', fontWeight: '500' },
    footerLinkText: { fontSize: 14, color: '#801DF7', fontWeight: '700' },
});